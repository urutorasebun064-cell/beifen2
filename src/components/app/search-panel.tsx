...
function isLongTrip(j: Journey | undefined) {
  if (!j) return false;
  return j.totalMinutes >= 150 || (j.transfers ?? 0) >= 3 || tripKm(j) >= 120;
}
